# PuppeteerExtraSharp6

[![NuGet Badge](https://buildstats.info/nuget/PuppeteerExtraSharp6)](https://www.nuget.org/packages/PuppeteerExtraSharp6)
...
🏴 [Puppeteer stealth plugin](https://github.com/Overmiind/PuppeteerExtraSharp6/tree/master/Plugins/ExtraStealth)
- Applies various evasion techniques to make detection of headless puppeteer harder.

📃 [Puppeteer anonymize UA plugin](https://github.com/Overmiind/PuppeteerExtraSharp6/tree/master/Plugins/AnonymizeUa) 
- Anonymizes the user-agent on all pages.

💀[Puppeteer recaptcha plugin](https://github.com/Overmiind/PuppeteerExtraSharp6/tree/master/Plugins/Recaptcha) 
